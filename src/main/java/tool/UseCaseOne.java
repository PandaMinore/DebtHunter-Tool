...
public class UseCaseOne {
	...
	private static Instances assignLabel(Instances test, FilteredClassifier fc1, FilteredClassifier fc2) throws Exception {
	...
	public static Instances userClassifierLabeling (Instances test, String modelPath1, String modelPath2) throws Exception {
